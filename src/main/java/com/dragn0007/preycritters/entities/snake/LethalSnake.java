...
public class LethalSnake extends Snake implements GeoEntity {

	public LethalSnake(EntityType<? extends LethalSnake> type, Level level) {
		super(type, level);
	}
	...
	public void registerGoals() {
		...
		this.goalSelector.addGoal(1, new NearestAttackableTargetGoal<>(this, Player.class, 16, true, false, entity ->
	...
	public boolean doHurtTarget(Entity entity) {
		if (super.doHurtTarget(entity)) {
			if (entity instanceof LivingEntity) {
				...
				if (i > 0) {
					((LivingEntity)entity).addEffect(new MobEffectInstance(MobEffects.WITHER, i * 20, 0), this);
				}
			}
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar controllers) {
		...
		controllers.add(LethalSnake.genericAttackAnimation(this, LethalSnake.STRIKE));
	}
	...
	public ResourceLocation getTextureLocation() {
		return LethalSnakeModel.Variant.variantFromOrdinal(getVariant()).resourceLocation;
	}

	public static final EntityDataAccessor<Integer> VARIANT = SynchedEntityData.defineId(LethalSnake.class, EntityDataSerializers.INT);
	...
	public static boolean checkLethalSnakeSpawnRules(EntityType<LethalSnake> type, LevelAccessor levelAccessor, MobSpawnType p_218258_, BlockPos pos, RandomSource p_218260_) {
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor serverLevelAccessor, DifficultyInstance instance, MobSpawnType spawnType, @Nullable SpawnGroupData data, @Nullable CompoundTag tag) {
		...
		setVariant(random.nextInt(LethalSnakeModel.Variant.values().length));
