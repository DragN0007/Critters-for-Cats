...
public class VenomousSnake extends Snake implements GeoEntity {

	public VenomousSnake(EntityType<? extends VenomousSnake> type, Level level) {
		super(type, level);
	}
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar controllers) {
		...
		controllers.add(VenomousSnake.genericAttackAnimation(this, VenomousSnake.STRIKE));
	}
	...
	public ResourceLocation getTextureLocation() {
		return VenomousSnakeModel.Variant.variantFromOrdinal(getVariant()).resourceLocation;
	}

	public static final EntityDataAccessor<Integer> VARIANT = SynchedEntityData.defineId(VenomousSnake.class, EntityDataSerializers.INT);
	...
	public static boolean checkVenomousSnakeSpawnRules(EntityType<VenomousSnake> type, LevelAccessor levelAccessor, MobSpawnType p_218258_, BlockPos pos, RandomSource p_218260_) {
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor serverLevelAccessor, DifficultyInstance instance, MobSpawnType spawnType, @Nullable SpawnGroupData data, @Nullable CompoundTag tag) {
		...
		setVariant(random.nextInt(VenomousSnakeModel.Variant.values().length));
